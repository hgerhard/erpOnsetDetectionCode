...
%   parameter 'windowLenSec'. [This is the DEFAULT algorithm.] You can also
%   specify if the onset value should be positive or negative via the
%   optional parameter 'signedOnset' followed by 1 or -1.
%
%   '2.5stdThresh' is very similar to 'OsmanEtAl1992' except it does not
%   require two following windows to exceed the threshold. You can also
%   specify if the onset value should be positive or negative via the
%   optional parameter 'signedOnset' followed by 1 or -1.
%   
%   'HardThresh' a single hard threshold is used. You must supply the
%   optional parameter 'hardThresh' followed by a numerical value.
%   Otherwise the threshold defaults to 1.
%
%   'FractionalArea' finds the point at which the area under the time
%   series exceeds some fractional area value, which must be provided by
%   supplying the optional parameter 'areaFraction' followed by a numerical
%   value. Otherwise the area defaults to 0.25.
% 
%   'FractionalPeakLatency' finds the first point at which at least a
%   percentage of the maximum amplitude is reached. You must supply the
%   fractional value with the optional parameter 'peakFraction' followed by
%   a numerical value. Otherwise it defaults to 0.5.
%   
